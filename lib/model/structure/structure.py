...
class _Structure_inference(nn.Module):
    ...
    def forward(self, edges,rois,whole,local,boxes):
        ...
        for t in range(n_steps):
            ...
            # weight_confusion
            # hi = torch.mul(hi1, self.weight_confusion[0]) + torch.mul(hi2, 1 - self.weight_confusion[1]) \
